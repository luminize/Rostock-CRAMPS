...
import bebopr_pp_pepper as hardware
...
motion.setup_motion(kinematics='lineardeltakins', with_base_thread=True)
hardware.init_hardware('servo-thread')
storage.init_storage('storage.ini')

# reading functions
hardware.hardware_read('servo-thread')
...
#print("numExtruders = %s" % numExtruders)
...
# write out functions
hardware.hardware_write(thread='servo-thread')
